...
/*NIL $clsbpCreditCard	= new clsbpCreditCard($connect, $includePath,"clsbpCreditCard");
...
/*NIL	$pageRange	        = HTMLOptionKeyValArray($arrPageRange,$clsbpCreditCard->pageSize);
...
NIL*/	
	...
	include_once($includePath."templates/bopaBank.tmpl.php");
}
ob_end_flush(); 
?>