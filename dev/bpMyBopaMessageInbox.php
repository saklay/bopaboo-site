...
<script language="javascript" type="text/javascript">
	function readMessage(id) {
		var frm = document.frmInbox;
		frm.clsbpMessages_messageId.value = id;
		//alert(frm.clsbpMessages_messageId.value);
		//frm.clsbpMessages_action.value = "DELETES";
		frm.submit();
	}
	
	function closeMsg() {
		document.getElementById('infoMsg').innerHTML = "&nbsp;";
		document.getElementById('envInfoMsg').style.display="none";
		document.getElementById('envInfoMsg').style.visibility="hidden";
	}
...
function writeMain($connect, $includePath) {
	...
	include_once($includePath."templates/bpMyBopaMessageInbox.tmpl.php");
}
