...
<link rel="stylesheet" href="https://staging.bopaboo.com/dev/styles/thickbox.css" type="text/css"  />
...
$clsbpUserLogin->postContactForUserDeatils();
	include_once($includePath."templates/bpReConfirmPassword.tmpl.php");
}
