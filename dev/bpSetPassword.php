...
function writeMain($connect, $includePath) {
	...
	$encodeid = base64_decode(base64_decode($clsbpUserLogin->bi_MemberId));
	$clsbpUserLogin->retrieveLogin($encodeid);        
	include_once($includePath."templates/bpSetPassword.tmpl.php");
}
