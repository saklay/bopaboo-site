...
//error_reporting(E_ALL);
  	include_once($includePath."classes/bpPlaceOrder.cls.php");
...
function writeMain($connect, $includePath) {
	...
	/*----------------------------------------------------------------------------	
	 Created cart object*/
	$clsbpPlaceOrder	= new clsbpPlaceOrder($connect, $includePath,"clsbpPlaceOrder");
			
	$clsbpPlaceOrder->postPlaceOrder();
...
/*	$clsbpPayment	= new clsbpPayment($connect, $includePath,"clsbpPayment");
	...
	include_once($includePath."templates/orderThankYou.tmpl.php");
