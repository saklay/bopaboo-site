...
<div id="header"> <a href="<?php if($_SESSION["USERID"]!=''){ echo "bpMyBopa.php";} else{ echo "index.php";}?>" id="logo">Bopaboo</a>
  ...
  <div id="login">
    ...
    <a href="bpSignIn.php?height=316&width=100px&modal=true&returnUrl=<?php $currentpageurl=getCurrentPage(); echo getCurrentPage();   ?>" class="thickbox">Sign-in</a>or<a href="https://staging.bopaboo.com/dev/bpUserSignup.php">Register</a>
    <?php } ?>
  </div>
