      ...
      var s = xmlHttp.responseText;
		  ...
		  if(s=="") {
			  ...
			  document.getElementById("content2").style.display = 'none';
		  	  document.getElementById("importEmailAddressAol").style.display = '';
			...
			document.getElementById("importEmailAddressAol").style.display = 'none';
...
<div id="importEmailAddressAol" style="display:">
  ...
  <div class="top">
	...
	<div class="contents" id="content1" style="display:">
    	<span class="hdimg">
        	<img src="images/icon-aol.jpg" alt="Loading... Please wait" width="94" height="40" align="absmiddle" />         </span>
            <div id="errordisplay"></div>
         <span class="login">
   	  <label><span class="hdr">Screen Name</span>
      <input name="clsbpMailImport_username" type="text" id="username" /></label>
            ...
            <span class="hdr">&nbsp;</span><span class="forgotpass"><a target="_blank" href="
https://account.login.aol.com/opr/_cqr/opr/opr.psp?sitedomain=sns.webmail.aol.com&authLev=0&siteState=ver:3%7Cac:WS%7Cat:SNS%7Cld:webmail.aol.com%7Cuv:AOL%7Clc:en-us%7Cmt:AOL%7Csnt:ScreenName&lang=en&locale=us&offerId=webmail-en-us&seamless=novl" >Forgot your Password?</a></span>
            <span class="commontext">We will not store your login. It will only be temporarily used to access your AOL address book.</span>
         </span>
    </div>
...
<input name="clsbpMailImport_provider" type="hidden" value="A"/>
