...
document.getElementById(sd).style.display ='none';
    ...
    <div id="container">
      ...
      <div id="submenu">
            <a href="<?php echo HTTP ?>bpAccountActivity.php" class="current">bopaBank</a>	|	<a href="<?php echo HTTP ?>bpFeedback.php?feedbacklist=provided">Feedback</a>	|	<a href="<?php echo HTTP ?>bpMyBopaMessageInbox.php">Messages</a>
      </div>
        ...
        <table width="914" border="0" cellspacing="0" cellpadding="0" class="datalist">
                <tr>
                  <td><ul id="bopabank-menu">
                    ...
                    <li class="accountactivity"><a href="<?php echo HTTP ?>bpAccountActivity.php" class="currentsel">Account Activity</a></li>
                    <li class="withdrawfunds"><a href="<?=HTTPS?>bpWithdraw.php">Withdraw Funds</a></li>
                    <li class="managecredit"><a href="<?=HTTPS?>bpBopaBank.php">Manage Credit Card</a></li>
                  </ul></td>
                </tr>            <?php

echo "<script type='text/javascript'>fn_showTab('accountActivity','PCI/bpAjaxAccountActivity.php?optionVal=1&sortDirection=DESC&sortColumn=ord_date');
</script>";
          ...
          <input type="hidden"  name="clsbpBopaBank_submitted" value="1">
                <tr>
                    <td class="hdr"><div id="searchpage-hdr">Show
                      <select name="showjmenu" id="showjmenu" class="showjmenu" onchange="javascript:changeOption('PCI/bpAjaxAccountActivity.php','1','clsbpBopaBank','frmbopabank','<?php echo $extraParameters;?>','accountActivity');">
                        ...
                        <option value="4" <?php if($optionVal==4) {?>selected="selected"<?php } ?>>All Withdrawals</option>
                      </select>&nbsp;&nbsp;&nbsp; Within
                      <select name="withinjmenu" id="withinjmenu" class="withinjmenu" onchange="javascript:changeOption('PCI/bpAjaxAccountActivity.php','1','clsbpBopaBank','frmbopabank','<?php echo $extraParameters;?>','accountActivity');">
