...
?>
         ...
         <input type="hidden"  name="clsbpBopaBank_pageSize" value="<?php echo $clsbpBopaBank->pageSize; ?>">
          ...
          <input type="hidden"  name="clsbpBopaBank_submitted" value="1">
               ...
               <tr>
                  <td class="ftr"> <div id="pages" align="center"> <?php
			
				// $clsbpBopaBank->clsbpPaginate->writeHTMLPageRanges("clsbpBopaBank", "frmbopabank", $extraParameters);
				echo $clsbpBopaBank->clsbpPaginate->getHTMLPageRangesForAjax("bpAjaxAccountActivity.php","clsbpBopaBank", "frmbopabank", $extraParameters,$tgName)
