 <div id="container">
          ...
          <table width="914" border="0" cellspacing="0" cellpadding="0" class="datalist">
                <tr>
                  <td><ul id="bopabank-menu">
                    ...
                    <li class="withdrawfunds"><a href="<?= HTTPS ?>bpChangePassword.php">Password</a></li>
  ...
  <br />
  <label>My URL</label>
                    <p><a href="<?= HTTP?>bpMemberStore.php?mS=<?php echo $_COOKIE['COOKIE_USERNAME']  ;?>" style="text-decoration:none; color:#000000">http://staging.bopaboo.com/dev/<?php echo $_COOKIE['COOKIE_USERNAME'] ;?></a></p>
