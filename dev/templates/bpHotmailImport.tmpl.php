...
function fnValidates()
{
	...
	return false;
	 ...
	 pass = document.form1.clsbpMailImport_password.value;
      ...
      var s = xmlHttp.responseText;
		  ...
		  if(s=="") {
			  ...
			  document.getElementById("content2").style.display = 'none';
		  	  document.getElementById("importEmailAddressHotmail").style.display = '';
			...
			document.getElementById("importEmailAddressHotmail").style.display = 'none';
...
<div id="importEmailAddressHotmail" style="display:">
  ...
  <div class="top">
	...
	<div class="contents" id="content1" style="display:">
    	<span class="hdimg">
        	<img src="images/icon-hotmail1.jpg" alt="Loading... Please wait" width="136" height="40" align="absmiddle" />         </span>
            <div id="errordisplay"></div>
         <span class="login">
   	  <label><span class="hdr">Email Address</span>
      <input name="clsbpMailImport_username" type="text" id="username" /></label>
            ...
            <span class="hdr">&nbsp;</span><span class="forgotpass"><a target="_blank" href="https://account.live.com/ResetPassword.aspx?mkt=EN-US&ru=https://login.live.com/login.srf%3flc%3d1033%26wa%3dwsignin1.0%26rpsnv%3d10%26ct%3d1212179075%26rver%3d4.5.2130.0%26wp%3dMBI%26wreply%3dhttp:%252F%252Fmail.live.com%252Fdefault.aspx%26id%3d64855%26bk%3d1212179076%26lc%3d1033%26vv%3d550&lc=1033" >Forgot your Password?</a></span>
            <span class="commontext">We will not store your login. It will only be temporarily used to access your Hotmail address book.</span>
         </span>
    </div>
...
<input name="clsbpMailImport_provider" type="hidden" value="M"/>
