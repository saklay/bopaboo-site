          ...
          <tr>
            <td class="bodymemberstorebox"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="7%" align="left" valign="middle"><?php $clsbpRatings->fn_showUserRatings_halfstar($clsbpFileDetails->bi_sellerId);?></td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td width="50%" class="labels2"><div class="getaquestionimg"><a href="bpMyBopaMessageCompose.php?clsbpMessages_newToId=<?php echo $clsbpFileDetails->bi_sellerId; ?>"><img src="images/store-ico.png" width="27" height="26" border="0" align="absmiddle" /></a></div>
                    <div id="getaquestion">Got a Question?                    
                      ...
                      <tr>
                        ...
                        <td align="left" class="<?php echo $class; ?> spacing" onclick="javascript: fn_viewDetails(<?php echo $row['bi_file_id'];?>);" ><!--<img src="images/rate_1star.png" alt="1 star rating" width="96" height="20" border="0" align="absmiddle" /><span class="spacing">(169)</span>--><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="7%" align="left" valign="middle" style="border:none" ><img src="images/rate_<?php echo $row["avgRating"] ?>star.png" alt="Seller Rating" width="96" height="20" border="0" align="absmiddle" /></td>
                            <td width="64%" align="left" valign="middle" style="border:none">(<?php echo $clsbpRatings->totalReviews;?>)</td>
                          </tr>
                        </table></td>
