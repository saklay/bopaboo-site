                    	...
                    	<div class="holder">
                         ...
                         <div class="holder">
                        	<span class="ltitle">View My Music Store:</span>
                       		 <span class="rdetails">
                        		<a href="<?php  echo constant("URL").$_COOKIE['COOKIE_USERNAME']; ?>">http://staging.bopaboo.com/dev/<?php echo $_COOKIE['COOKIE_USERNAME'] ;?></a>
                          	</span>
                        </div>
                        <div class="holder">
...
<!-- 	<img src="images/icon-facebook.jpg" alt="facebook" width="100" height="37" /><img src="images/icon-myspace.jpg" alt="my space" width="147" height="34" class="lspace" /><img src="images/icon-bebo.jpg" alt="Bebo" width="99" height="37" class="lspace" />-->
                ...
                <form name="frmMyBopa" method="POST">
                  ...
                  <div class="contents">
                   	<ul class="tabs">
                    		<li id="tab001"><a href="javascript: void(0);" id="slidein" onmouseover="javascript: show(1);" onmouseout="javascript: hide(1);">Messages</a></li>
                        	<li id="tab002"><a href="javascript: void(0);" id="slidein2" onmouseover="javascript: show(2);" onmouseout="javascript: hide(2);">Saved Sellers</a></li>
                    	</ul>
                         <div id="messages">
                            &nbsp;
                         </div>
                       	...
                       	<ul class="tabs">
                        	<li id="tab003"><a href="javascript: void(0);" id="slidein3" onmouseover="javascript: show(3);" onmouseout="javascript: hide(3);">Popular Searches</a></li>
                        	<li id="tab004"><a href="javascript: void(0);" id="slidein4" onmouseover="javascript: show(4);" onmouseout="javascript: hide(4);">Saved Searches</a></li>
                        </ul>
			<div id="search">
                        	 &nbsp;
                        </div>
