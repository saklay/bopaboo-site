...
<div id="ViewCartpageheadPlaceorder">
  <h1>Shopping Cart</h1>
  <h2><a href="<?= HTTP ?>bpViewCart.php">View Cart</a> </h2>
  <img src="images/icon-arrow-viewcart.png" alt="Next" width="57" height="12" class="arrow" />
  <h2><a href="<?= HTTPS ?>bpPayment.php">Payment</a></h2>
  <img src="images/icon-arrow-viewcart.png" alt="Next" width="57" height="12" class="arrow" />
  <h2><a href="<?= HTTPS ?>bpOrderDetails.php"><img src="images/btn-viewcart.png" alt="View Cart" width="39" height="44" border="0" class="viewcart" />Place Order</a></h2>
</div>
<div id="viewcart">
	 ...
	 // if (isset($_POST['clsbpCreditCard_txtCreditCardVer1'])) $clsbpCreditCard->i_CCV1   	          = trim($_POST['clsbpCreditCard_txtCreditCardVer1']);?>
      ...
      <table width="90%" border="0" cellpadding="0" cellspacing="0" id="viewcart_tbl1placeorder">
        ...
        <tr>
          ...
          <td width="169" align="right"><a onclick="return checkEmpty(<?php echo $cartSize; ?>);" href="<?= HTTP ?>bpThankYou.php?action=<?php echo $clsbpPayment->action; ?>&cardId=<?php echo $clsbpPayment->cardId; ?>"><img src="images/place-ordr-btn.jpg" width="165" height="26" border="0" /></a></td>
        </tr>
        <tr>
          <td colspan="2"><div align="right">By placing your order, you agree to the bopaboo <a href="<?= HTTP ?>bpTermsOfService.php">Terms of Use</a> and <a href="<?= HTTP ?>bpPrivacyPolicy.php">Privacy Policy</a>.</div></td>
          </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
      ...
      <tr>
        ...
        if (isset($_POST['clsbpCreditCard_txtCreditCardVer1'])) $clsbpCreditCard->i_CCV1   	          = trim($_POST['clsbpCreditCard_txtCreditCardVer1']);
		   ...
		   ?>
            ...
            <tr>
              <td><a href="<?= HTTPS ?>bpPayment.php?cardId=<?php echo $clsbpPayment->cardId; ?>&editcc=<?php echo $clsbpPayment->action; ?>">Edit Payment Information</a></td>
            </tr>
          </table></td>
        </tr>
        <tr>
      ...
      <table border="0" cellspacing="0" cellpadding="0" class="viewcartrightsidebox-placeorder">
        ...
        <tr>
          <td align="center" class="tbl002b"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td height="40" align="center"><a onclick="return checkEmpty(<?php echo $cartSize; ?>);" href="<?= HTTP ?>bpThankYou.php?action=<?php echo $clsbpPayment->action; ?>&cardId=<?php echo $clsbpPayment->cardId; ?>"><img src="images/place-ordr-btn.jpg" width="165" height="26" border="0" /></a></td>
              </tr>
            
            <tr>
              <td height="40" align="center"><a href="<?= HTTPS ?>bpPayment.php?cardId=<?php echo $clsbpPayment->cardId; ?>&editcc=<?php echo $clsbpPayment->action; ?>"><img src="images/go-back-btn.jpg" width="165" height="26" border="0" /></a></td>
            </tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" id="viewcart_tbl-placeorder3">
              ...
              <tr>
                <td class="cartlistings"><h2>Security &amp; Privacy</h2>
                    <p>Every transaction on bopaboo is secure. Any personal information you give us will be handed according to our <a href="<?= HTTP ?>bpPrivacyPolicy.php">Privacy Policy</a>.</p>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
