...
<form name="frmcart"  method="post" action="">
  ...
  <div id="container">
      ...
      <div id="shoppingLs">
      	...
      	<ul class="cartLinks">
        	<li class="viewCart active"><a href="bpViewCart.php">view cart</a></li>
...
<?php
				...
				if ($tempCount == 0) {
					$prodCount = 0;
?>
            <div class="cartItemRight" style="margin-top:-125px;">
            	<img src="<?php echo IMAGEPATH; ?>prodimg001.png" alt="cart item" />
                <ul>
                    ...
                    <li><a href="javascript:void(0);" onclick="return fn_cart(<?php echo $r['product']; ?>);"><img src="<?php echo IMAGEPATH; ?>btnDelete.gif" alt="delete" /></a></li>
                </ul> 
            </div>
...
?>
            <div class="cartItem" style="height:120px;">
            	<img src="<?php echo IMAGEPATH; ?>prodimg001.png" alt="cart item" />
                <ul>
                	<li><?php print stripslashes($fileDetails['vc_title_nm_mod']);?></li>
                    <li><strong>by <?php print stripslashes($fileDetails['vc_artists_nm_mod']);?></strong></li>
