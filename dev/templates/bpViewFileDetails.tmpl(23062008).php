                ...
                <td><table width="863" border="0" cellpadding="0" cellspacing="0" class="item-page-footer">
                  ...
                  <tr>
                    <td class="contentbody"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="45" align="center"><a href="#"><img src="images/icon-suitcase.jpg" alt="View Member Store" width="29" height="35" border="0" align="absmiddle" /></a><a href="<?php  echo constant("URL").str_replace(" ","-",$clsbpFileDetails->memberDisplayName); ?>"  class="itemfooterlinks">View Member Store</a></td>
                        <td align="center">
