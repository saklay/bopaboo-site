...
<div id="importEmailAddressHotmail" style="display:">
  ...
  <div class="top">
	...
	<div class="contents" id="content1" style="display:">
    	<span class="hdimg">
        	<img src="images/icon-yahoo.jpg" alt="Loading...Yahoo! Please wait"  width="130" height="39" align="absmiddle" />         </span>
      ...
      <input name="clsbpMailImport_username" type="text" id="username" /></label>
            ...
            <span class="hdr">&nbsp;</span><span class="forgotpass"><a  target="_blank" href="https://edit.yahoo.com/forgot?login=&intl=us&done=http://mail.yahoo.com&src=ym&bail= " >Forgot your Password?</a></span>
            <span class="commontext">We will not store your login. It will only be temporarily used to access your Yahoo address book.</span>
         </span>
    </div>
...
<input name="clsbpMailImport_provider" type="hidden" value="Y"/>
